...
# image_path = data_root + "dataset\\chest_xray_pneumonia\\"
...
# with open('class_indices(chest_pneumonia).json', 'w') as json_file:
...
# save_path = './{}(chest_pneumonia)Net.pth'.format(model_name)
# save_path = './{}(covid_chest)Net(UsePreTrain).pth'.format(model_name)

epoch_number = 50

# filename = './trainProcess/{} chest_Train_process.txt'.format(model_name)
# filename = './trainProcess/{} chest_pneumonia_Train_process.txt'.format(model_name)
filename = './trainProcess/{} chest_3_Train_process.txt'.format(model_name)
# filename = './trainProcess/{} covid_chest_Train_process(UsePreTrain).txt'.format(model_name)
# filename = './trainProcess/{} covid_chest_Train_process'.format(model_name)
